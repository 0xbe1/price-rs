...
pub mod uniswap_v2_route_02 {
    ...
    #[doc = "UniswapV2Route02 was auto-generated with ethers-rs Abigen. More information at: https://github.com/gakonst/ethers-rs"]
    use std::sync::Arc;
    pub static UNISWAPV2ROUTE02_ABI: ethers::contract::Lazy<ethers::core::abi::Abi> =
    ...
    pub struct UniswapV2Route02<M>(ethers::contract::Contract<M>);
    impl<M> Clone for UniswapV2Route02<M> {
        fn clone(&self) -> Self {
            UniswapV2Route02(self.0.clone())
        }
    }
    impl<M> std::ops::Deref for UniswapV2Route02<M> {
        type Target = ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M: ethers::providers::Middleware> std::fmt::Debug for UniswapV2Route02<M> {
        fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
            f.debug_tuple(stringify!(UniswapV2Route02))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ethers::providers::Middleware> UniswapV2Route02<M> {
        ...
        pub fn new<T: Into<ethers::core::types::Address>>(
            ...
            ethers::contract::Contract::new(address.into(), UNISWAPV2ROUTE02_ABI.clone(), client)
                .into()
        }
    ...
    impl<M: ethers::providers::Middleware> From<ethers::contract::Contract<M>> for UniswapV2Route02<M> {
    ...
    pub enum UniswapV2Route02Calls {
        Weth(WethCall),
    ...
    impl ethers::core::abi::AbiDecode for UniswapV2Route02Calls {
        fn decode(data: impl AsRef<[u8]>) -> Result<Self, ethers::core::abi::AbiError> {
            if let Ok(decoded) = <WethCall as ethers::core::abi::AbiDecode>::decode(data.as_ref()) {
                return Ok(UniswapV2Route02Calls::Weth(decoded));
            }
            if let Ok(decoded) =
                <AddLiquidityCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(UniswapV2Route02Calls::AddLiquidity(decoded));
            }
            if let Ok(decoded) =
                <AddLiquidityETHCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(UniswapV2Route02Calls::AddLiquidityETH(decoded));
            }
            if let Ok(decoded) =
                <FactoryCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(UniswapV2Route02Calls::Factory(decoded));
            }
            if let Ok(decoded) =
                <GetAmountInCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(UniswapV2Route02Calls::GetAmountIn(decoded));
            }
            if let Ok(decoded) =
                <GetAmountOutCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(UniswapV2Route02Calls::GetAmountOut(decoded));
            }
            if let Ok(decoded) =
                <GetAmountsInCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(UniswapV2Route02Calls::GetAmountsIn(decoded));
            }
            if let Ok(decoded) =
                <GetAmountsOutCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(UniswapV2Route02Calls::GetAmountsOut(decoded));
            }
            if let Ok(decoded) = <QuoteCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(UniswapV2Route02Calls::Quote(decoded));
            }
            if let Ok(decoded) =
                <RemoveLiquidityCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(UniswapV2Route02Calls::RemoveLiquidity(decoded));
            }
            if let Ok(decoded) =
                <RemoveLiquidityETHCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(UniswapV2Route02Calls::RemoveLiquidityETH(decoded));
            }
            if let Ok (decoded) = < RemoveLiquidityETHSupportingFeeOnTransferTokensCall as ethers :: core :: abi :: AbiDecode > :: decode (data . as_ref ()) { return Ok (UniswapV2Route02Calls :: RemoveLiquidityETHSupportingFeeOnTransferTokens (decoded)) }
            if let Ok(decoded) =
                <RemoveLiquidityETHWithPermitCall as ethers::core::abi::AbiDecode>::decode(
                    data.as_ref(),
                )
            {
                return Ok(UniswapV2Route02Calls::RemoveLiquidityETHWithPermit(decoded));
            }
            if let Ok (decoded) = < RemoveLiquidityETHWithPermitSupportingFeeOnTransferTokensCall as ethers :: core :: abi :: AbiDecode > :: decode (data . as_ref ()) { return Ok (UniswapV2Route02Calls :: RemoveLiquidityETHWithPermitSupportingFeeOnTransferTokens (decoded)) }
            if let Ok(decoded) =
                <RemoveLiquidityWithPermitCall as ethers::core::abi::AbiDecode>::decode(
                    data.as_ref(),
                )
            {
                return Ok(UniswapV2Route02Calls::RemoveLiquidityWithPermit(decoded));
            }
            if let Ok(decoded) =
                <SwapETHForExactTokensCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(UniswapV2Route02Calls::SwapETHForExactTokens(decoded));
            }
            if let Ok(decoded) =
                <SwapExactETHForTokensCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(UniswapV2Route02Calls::SwapExactETHForTokens(decoded));
            }
            if let Ok (decoded) = < SwapExactETHForTokensSupportingFeeOnTransferTokensCall as ethers :: core :: abi :: AbiDecode > :: decode (data . as_ref ()) { return Ok (UniswapV2Route02Calls :: SwapExactETHForTokensSupportingFeeOnTransferTokens (decoded)) }
            if let Ok(decoded) =
                <SwapExactTokensForETHCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(UniswapV2Route02Calls::SwapExactTokensForETH(decoded));
            }
            if let Ok (decoded) = < SwapExactTokensForETHSupportingFeeOnTransferTokensCall as ethers :: core :: abi :: AbiDecode > :: decode (data . as_ref ()) { return Ok (UniswapV2Route02Calls :: SwapExactTokensForETHSupportingFeeOnTransferTokens (decoded)) }
            if let Ok(decoded) =
                <SwapExactTokensForTokensCall as ethers::core::abi::AbiDecode>::decode(
                    data.as_ref(),
                )
            {
                return Ok(UniswapV2Route02Calls::SwapExactTokensForTokens(decoded));
            }
            if let Ok (decoded) = < SwapExactTokensForTokensSupportingFeeOnTransferTokensCall as ethers :: core :: abi :: AbiDecode > :: decode (data . as_ref ()) { return Ok (UniswapV2Route02Calls :: SwapExactTokensForTokensSupportingFeeOnTransferTokens (decoded)) }
            if let Ok(decoded) =
                <SwapTokensForExactETHCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(UniswapV2Route02Calls::SwapTokensForExactETH(decoded));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(UniswapV2Route02Calls::SwapTokensForExactTokens(decoded));
            }
            Err(ethers::core::abi::Error::InvalidData.into())
        }
    }
    impl ethers::core::abi::AbiEncode for UniswapV2Route02Calls {
        fn encode(self) -> Vec<u8> {
            match self { UniswapV2Route02Calls :: Weth (element) => element . encode () , UniswapV2Route02Calls :: AddLiquidity (element) => element . encode () , UniswapV2Route02Calls :: AddLiquidityETH (element) => element . encode () , UniswapV2Route02Calls :: Factory (element) => element . encode () , UniswapV2Route02Calls :: GetAmountIn (element) => element . encode () , UniswapV2Route02Calls :: GetAmountOut (element) => element . encode () , UniswapV2Route02Calls :: GetAmountsIn (element) => element . encode () , UniswapV2Route02Calls :: GetAmountsOut (element) => element . encode () , UniswapV2Route02Calls :: Quote (element) => element . encode () , UniswapV2Route02Calls :: RemoveLiquidity (element) => element . encode () , UniswapV2Route02Calls :: RemoveLiquidityETH (element) => element . encode () , UniswapV2Route02Calls :: RemoveLiquidityETHSupportingFeeOnTransferTokens (element) => element . encode () , UniswapV2Route02Calls :: RemoveLiquidityETHWithPermit (element) => element . encode () , UniswapV2Route02Calls :: RemoveLiquidityETHWithPermitSupportingFeeOnTransferTokens (element) => element . encode () , UniswapV2Route02Calls :: RemoveLiquidityWithPermit (element) => element . encode () , UniswapV2Route02Calls :: SwapETHForExactTokens (element) => element . encode () , UniswapV2Route02Calls :: SwapExactETHForTokens (element) => element . encode () , UniswapV2Route02Calls :: SwapExactETHForTokensSupportingFeeOnTransferTokens (element) => element . encode () , UniswapV2Route02Calls :: SwapExactTokensForETH (element) => element . encode () , UniswapV2Route02Calls :: SwapExactTokensForETHSupportingFeeOnTransferTokens (element) => element . encode () , UniswapV2Route02Calls :: SwapExactTokensForTokens (element) => element . encode () , UniswapV2Route02Calls :: SwapExactTokensForTokensSupportingFeeOnTransferTokens (element) => element . encode () , UniswapV2Route02Calls :: SwapTokensForExactETH (element) => element . encode () , UniswapV2Route02Calls :: SwapTokensForExactTokens (element) => element . encode () }
        }
    }
    impl ::std::fmt::Display for UniswapV2Route02Calls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self { UniswapV2Route02Calls :: Weth (element) => element . fmt (f) , UniswapV2Route02Calls :: AddLiquidity (element) => element . fmt (f) , UniswapV2Route02Calls :: AddLiquidityETH (element) => element . fmt (f) , UniswapV2Route02Calls :: Factory (element) => element . fmt (f) , UniswapV2Route02Calls :: GetAmountIn (element) => element . fmt (f) , UniswapV2Route02Calls :: GetAmountOut (element) => element . fmt (f) , UniswapV2Route02Calls :: GetAmountsIn (element) => element . fmt (f) , UniswapV2Route02Calls :: GetAmountsOut (element) => element . fmt (f) , UniswapV2Route02Calls :: Quote (element) => element . fmt (f) , UniswapV2Route02Calls :: RemoveLiquidity (element) => element . fmt (f) , UniswapV2Route02Calls :: RemoveLiquidityETH (element) => element . fmt (f) , UniswapV2Route02Calls :: RemoveLiquidityETHSupportingFeeOnTransferTokens (element) => element . fmt (f) , UniswapV2Route02Calls :: RemoveLiquidityETHWithPermit (element) => element . fmt (f) , UniswapV2Route02Calls :: RemoveLiquidityETHWithPermitSupportingFeeOnTransferTokens (element) => element . fmt (f) , UniswapV2Route02Calls :: RemoveLiquidityWithPermit (element) => element . fmt (f) , UniswapV2Route02Calls :: SwapETHForExactTokens (element) => element . fmt (f) , UniswapV2Route02Calls :: SwapExactETHForTokens (element) => element . fmt (f) , UniswapV2Route02Calls :: SwapExactETHForTokensSupportingFeeOnTransferTokens (element) => element . fmt (f) , UniswapV2Route02Calls :: SwapExactTokensForETH (element) => element . fmt (f) , UniswapV2Route02Calls :: SwapExactTokensForETHSupportingFeeOnTransferTokens (element) => element . fmt (f) , UniswapV2Route02Calls :: SwapExactTokensForTokens (element) => element . fmt (f) , UniswapV2Route02Calls :: SwapExactTokensForTokensSupportingFeeOnTransferTokens (element) => element . fmt (f) , UniswapV2Route02Calls :: SwapTokensForExactETH (element) => element . fmt (f) , UniswapV2Route02Calls :: SwapTokensForExactTokens (element) => element . fmt (f) }
        }
    }
    impl ::std::convert::From<WethCall> for UniswapV2Route02Calls {
        fn from(var: WethCall) -> Self {
            UniswapV2Route02Calls::Weth(var)
        }
    }
    impl ::std::convert::From<AddLiquidityCall> for UniswapV2Route02Calls {
        fn from(var: AddLiquidityCall) -> Self {
            UniswapV2Route02Calls::AddLiquidity(var)
        }
    }
    impl ::std::convert::From<AddLiquidityETHCall> for UniswapV2Route02Calls {
        fn from(var: AddLiquidityETHCall) -> Self {
            UniswapV2Route02Calls::AddLiquidityETH(var)
        }
    }
    impl ::std::convert::From<FactoryCall> for UniswapV2Route02Calls {
        fn from(var: FactoryCall) -> Self {
            UniswapV2Route02Calls::Factory(var)
        }
    }
    impl ::std::convert::From<GetAmountInCall> for UniswapV2Route02Calls {
        fn from(var: GetAmountInCall) -> Self {
            UniswapV2Route02Calls::GetAmountIn(var)
        }
    }
    impl ::std::convert::From<GetAmountOutCall> for UniswapV2Route02Calls {
        fn from(var: GetAmountOutCall) -> Self {
            UniswapV2Route02Calls::GetAmountOut(var)
        }
    }
    impl ::std::convert::From<GetAmountsInCall> for UniswapV2Route02Calls {
        fn from(var: GetAmountsInCall) -> Self {
            UniswapV2Route02Calls::GetAmountsIn(var)
        }
    }
    impl ::std::convert::From<GetAmountsOutCall> for UniswapV2Route02Calls {
        fn from(var: GetAmountsOutCall) -> Self {
            UniswapV2Route02Calls::GetAmountsOut(var)
        }
    }
    impl ::std::convert::From<QuoteCall> for UniswapV2Route02Calls {
        fn from(var: QuoteCall) -> Self {
            UniswapV2Route02Calls::Quote(var)
        }
    }
    impl ::std::convert::From<RemoveLiquidityCall> for UniswapV2Route02Calls {
        fn from(var: RemoveLiquidityCall) -> Self {
            UniswapV2Route02Calls::RemoveLiquidity(var)
        }
    }
    impl ::std::convert::From<RemoveLiquidityETHCall> for UniswapV2Route02Calls {
        fn from(var: RemoveLiquidityETHCall) -> Self {
            UniswapV2Route02Calls::RemoveLiquidityETH(var)
        }
    }
    impl ::std::convert::From<RemoveLiquidityETHSupportingFeeOnTransferTokensCall>
        for UniswapV2Route02Calls
    {
        fn from(var: RemoveLiquidityETHSupportingFeeOnTransferTokensCall) -> Self {
            UniswapV2Route02Calls::RemoveLiquidityETHSupportingFeeOnTransferTokens(var)
        }
    }
    impl ::std::convert::From<RemoveLiquidityETHWithPermitCall> for UniswapV2Route02Calls {
        fn from(var: RemoveLiquidityETHWithPermitCall) -> Self {
            UniswapV2Route02Calls::RemoveLiquidityETHWithPermit(var)
        }
    }
        ...
        for UniswapV2Route02Calls
    {
        fn from(var: RemoveLiquidityETHWithPermitSupportingFeeOnTransferTokensCall) -> Self {
            UniswapV2Route02Calls::RemoveLiquidityETHWithPermitSupportingFeeOnTransferTokens(var)
        }
    }
    impl ::std::convert::From<RemoveLiquidityWithPermitCall> for UniswapV2Route02Calls {
        fn from(var: RemoveLiquidityWithPermitCall) -> Self {
            UniswapV2Route02Calls::RemoveLiquidityWithPermit(var)
        }
    }
    impl ::std::convert::From<SwapETHForExactTokensCall> for UniswapV2Route02Calls {
        fn from(var: SwapETHForExactTokensCall) -> Self {
            UniswapV2Route02Calls::SwapETHForExactTokens(var)
        }
    }
    impl ::std::convert::From<SwapExactETHForTokensCall> for UniswapV2Route02Calls {
        fn from(var: SwapExactETHForTokensCall) -> Self {
            UniswapV2Route02Calls::SwapExactETHForTokens(var)
        }
    }
        ...
        for UniswapV2Route02Calls
    {
        fn from(var: SwapExactETHForTokensSupportingFeeOnTransferTokensCall) -> Self {
            UniswapV2Route02Calls::SwapExactETHForTokensSupportingFeeOnTransferTokens(var)
        }
    }
    impl ::std::convert::From<SwapExactTokensForETHCall> for UniswapV2Route02Calls {
        fn from(var: SwapExactTokensForETHCall) -> Self {
            UniswapV2Route02Calls::SwapExactTokensForETH(var)
        }
    }
        ...
        for UniswapV2Route02Calls
    {
        fn from(var: SwapExactTokensForETHSupportingFeeOnTransferTokensCall) -> Self {
            UniswapV2Route02Calls::SwapExactTokensForETHSupportingFeeOnTransferTokens(var)
        }
    }
    impl ::std::convert::From<SwapExactTokensForTokensCall> for UniswapV2Route02Calls {
        fn from(var: SwapExactTokensForTokensCall) -> Self {
            UniswapV2Route02Calls::SwapExactTokensForTokens(var)
        }
    }
        ...
        for UniswapV2Route02Calls
    {
        fn from(var: SwapExactTokensForTokensSupportingFeeOnTransferTokensCall) -> Self {
            UniswapV2Route02Calls::SwapExactTokensForTokensSupportingFeeOnTransferTokens(var)
        }
    }
    impl ::std::convert::From<SwapTokensForExactETHCall> for UniswapV2Route02Calls {
        fn from(var: SwapTokensForExactETHCall) -> Self {
            UniswapV2Route02Calls::SwapTokensForExactETH(var)
        }
    }
    impl ::std::convert::From<SwapTokensForExactTokensCall> for UniswapV2Route02Calls {
        fn from(var: SwapTokensForExactTokensCall) -> Self {
            UniswapV2Route02Calls::SwapTokensForExactTokens(var)
        }
    }
